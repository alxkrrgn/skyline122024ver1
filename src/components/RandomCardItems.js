...
const allItems = [
    ...
    { title: "Portfolio construction", description: "Portfolio construction, along with market research, involves the strategic allocation of assets to achieve a balanced and diversified portfolio that aligns with our investors risk tolerance and financial goals." },
    {
...
export { SixCardsRandom, GridContainerRandom };
//export default SixCardsRandom;
//export GridContainerRandom;